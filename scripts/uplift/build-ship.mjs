...
const ASSETS = [
  ...
  {
    id: 'runabout-cockpit',
    script: 'runabout_cockpit.py',
    blend: 'runabout_cockpit.blend',
    glb: 'meshes/ships/runabout-cockpit.glb',
    names: [
      'cockpit-shell', 'canopy-frame', 'canopy-glass', 'dashboard',
      'display-primary', 'display-nav', 'display-systems', 'cockpit-lights',
      'flight-stick', 'throttle-lever', 'brake-lever', 'trim-wheel', 'autopilot-rocker',
      'pedal-port', 'pedal-starboard', 'airlock-door', 'boarding-ramp',
  ...
  {
    id: 'surface-viewmodels',
    script: 'surface_viewmodels.py',
    blend: 'surface_viewmodels.blend',
    glb: 'meshes/viewmodels/surface-viewmodels.glb',
    names: [
      'field-tool-body', 'field-head-pick', 'field-head-drill', 'field-head-scanner',
      'field-scanner-emitter', 'field-head-sample', 'field-hand-left', 'field-hand-right',
      'skimmer-cowl', 'skimmer-bars', 'skimmer-display', 'skimmer-throttle',
      'skimmer-hand-left', 'skimmer-hand-right',
    ],
    perAsset: 2200,
    budget: 9000,
    skewLimit: null,
  },
  {
    ...
    script: 'surface_landmarks.py',
    blend: 'surface_landmarks.blend',
    glb: 'meshes/surface/landmark-kit.glb',
    names: [
      'standing-ring', 'stone-arch', 'perched-boulder', 'hoodoo-court', 'ice-organ',
      'pressure-ridge', 'basalt-choir', 'cinder-cone', 'fumarole-field', 'sea-stacks',
      'tide-arch', 'blowhole', 'award-fjords',
    ],
    perAsset: 900,
    budget: 11700,
    skewLimit: null,
  ...
  {
    id: 'surface-dressing',
    script: 'surface_dressing.py',
    blend: 'surface_dressing.blend',
    glb: 'meshes/surface/dressing-kit.glb',
    names: [
      'deposit-crystal-intact', 'deposit-crystal-cracked', 'deposit-crystal-depleted',
      'deposit-ferrous-intact', 'deposit-ferrous-cracked', 'deposit-ferrous-depleted',
      'deposit-fossil-intact', 'deposit-fossil-cracked', 'deposit-fossil-depleted',
      'deposit-brine-intact', 'deposit-brine-cracked', 'deposit-brine-depleted',
      'deposit-sulfur-intact', 'deposit-sulfur-cracked', 'deposit-sulfur-depleted',
      'deposit-biologic-intact', 'deposit-biologic-cracked', 'deposit-biologic-depleted',
      'clutter-desert-scrub', 'clutter-desert-ribs', 'clutter-ice-slab', 'clutter-ice-needles',
      'clutter-volcanic-slag', 'clutter-volcanic-bomb', 'clutter-ocean-shells',
      'clutter-ocean-coral', 'clutter-terrestrial-roots', 'clutter-terrestrial-pebbles',
      'clutter-exotic-shards', 'clutter-expedition-debris',
      'settlement-airlock', 'settlement-cargo-stack', 'settlement-service-tank',
      'settlement-pipe-run', 'settlement-railing', 'settlement-sign', 'settlement-worklight',
      'settlement-cable-reel', 'settlement-service-drone', 'settlement-awning',
      'vignette-spore-bloom', 'vignette-brine-garden', 'vignette-tide-chorus',
      'vignette-ember-swarm', 'vignette-burrow', 'vignette-lichen-colony',
      'vignette-nesting-colony', 'vignette-grazer-ring',
    ],
    perAsset: 900,
    budget: 36000,
    skewLimit: null,
  },
  {
    ...
    script: 'creature_variants.py',
    blend: 'creature_variants.blend',
    glb: 'meshes/surface/creature-variants.glb',
    names: [
      'meadow-drifter', 'sky-wisp', 'glass-shoal', 'dune-skink', 'tumbleweave',
      'firn-burrower', 'aurora-moth', 'cinder-wren', 'vent-lace', 'settlement-swift',
    ],
    perAsset: 900,
    budget: 9000,
    skewLimit: null,
  ...
  {
    id: 'weather-props',
    script: 'weather_props.py',
    blend: 'weather_props.blend',
    glb: 'meshes/surface/weather-props.glb',
    names: [
      'weather-windsock', 'weather-banner', 'weather-dust-streamer', 'weather-loose-straps',
      'weather-storm-vane', 'weather-icicles', 'weather-snow-drift', 'weather-puddle',
      'weather-rain-catcher', 'weather-drain-chain',
    ],
    perAsset: 900,
    budget: 9000,
    skewLimit: null,
